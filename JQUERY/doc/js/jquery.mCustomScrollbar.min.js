			...
			u = {
					...
					if ("undefined" != typeof t && null != t) {
						...
						return e(n).each(function() {
							...
							if (n.data(a)) {
								...
								c[0] = X.call(this, c[0], "y"), c[1] = X.call(this, c[1], "x"), s.moveDragger && (c[0] *= i.scrollRatio.y, c[1] *= i.scrollRatio.x), s.dur = oe() ? 0 : d, setTimeout(function() {
				...
				disable: function(t) {
					...
					return e(o).each(function() {
						...
						if (o.data(a)) {
							o.data(a);
							q.call(this, "remove"), k.call(this), t && B.call(this), M.call(this, !0), o.addClass(d[3])
						}
					})
				},
				destroy: function() {
					...
					return e(t).each(function() {
						...
						if (n.data(a)) {
							...
							r.live && m(r.liveSelector || e(t).selector), q.call(this, "remove"), k.call(this), B.call(this), n.removeData(a), K(this, "mcs"), c.remove(), s.find("img." + d[2]).removeClass(d[2]), l.replaceWith(s.contents()), n.removeClass(o + " _" + a + "_" + i.idx + " " + d[6] + " " + d[7] + " " + d[5] + " " + d[3]).addClass(d[4])
						}
					})
				}
			},
