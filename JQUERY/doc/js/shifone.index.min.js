$(function() {
    function a(a, e) { this.$element = $("#col-list"), this.options = l, this.colHeightArray = [], this.styleQueue = [], this._init() }
    var e = ["cuis"],
        t = $(window),
        l = { itemCls: "col-item", prefix: "waterfall", fitWidth: !0, colWidth: 210, gutterWidth: 3, gutterHeight: 3, align: "left", minCol: 1, maxCol: void 0, resizable: !0 };
    e.push("hife"), a.prototype = { constructor: a, _init: function(a) {
            var e = this.options;
            e.path;
            this._setColumns(), this._resetColumnsHeightArray(), this.reLayout(a), e.resizable && this._doResize() }, _getColumns: function() {
            var a = this.options,
                ...
                i = Math.floor(t / (l + d)),
                s = Math.max(i, u);
            return r && s > r ? r : s }, _setColumns: function() { this.cols = this._getColumns() }, _getItems: function(a) {
            var e = a.filter("." + this.options.itemCls).css({ position: "absolute" });
            return e }, _resetColumnsHeightArray: function() {
            var a, e = this.cols;
            for (this.colHeightArray.length = e, a = 0; e > a; a++) this.colHeightArray[a] = 0 }, layout: function(a, e) {
            ...
            this.$element.height(Math.max.apply({}, this.colHeightArray)), this.styleQueue = [], e && e.call(v), $("#main-loading").delay(5000).fadeOut("normal", function() { $("html,body").removeClass("loading-process") }) }, reLayout: function(a) {
            var e = this.$element.find("." + this.options.itemCls);
            this._resetColumnsHeightArray(), this.layout(e, a) }, _placeItems: function(a, e) {
            var t, l, d = $(a),
                u = this.options,
                r = u.colWidth,
                i = u.gutterWidth,
